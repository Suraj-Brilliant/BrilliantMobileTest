<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchCustomer.aspx.cs" Inherits="BrilliantWMS.Account.SearchCustomer" Theme="Blue" %>
...
<body>
    ...
    <div>
        ...
        <center>
            <table class="gridFrame" width="90%" style="margin: 3px 3px 3px 3px;">
                <tr>
                    ...
                    <tr>
                        <td style="text-align: left;">
                           <asp:Label ID="lblheader" CssClass="headerText" runat="server" Text="Customer List"></asp:Label>
                        </td>
                ...
                <tr>
                    <td>
                        <obout:Grid ID="GVCustomer" runat="server" AutoGenerateColumns="false" AllowFiltering="false"
                            ...
                            <Columns>
                                ...
                                <obout:Column DataField="Name" HeaderText="Customer Name" HeaderAlign="left"
                                    Align="left" Width="10%">
                                </obout:Column>
                                 <obout:Column DataField="EmailID" HeaderText="Email ID" HeaderAlign="left" Align="left"
                                    Width="14%">
                                </obout:Column>
                                <obout:Column DataField="PhoneNo" HeaderText="Phone No." HeaderAlign="left" Align="left"
                                    Width="10%">
                                </obout:Column>
                                 <obout:Column DataField="AddressLine1" HeaderText="Address" HeaderAlign="left"
                                    Align="left" Width="10%">
                                </obout:Column>
                             </Columns>
                        </obout:Grid>
    ...
    <script type="text/javascript">
        ...
        function SelectedPrdRec() {
            ...
            for (var i = 0; i < GVCustomer.PageSelectedRecords.length; i++) {
        ...
        function GetAccount() {
            ...
            if (count > 1) {
                ...
                if (GVCustomer.SelectedRecords.length > 0) {
                    for (var i = 0; i < GVCustomer.SelectedRecords.length; i++) {
                        var record = GVCustomer.SelectedRecords[i];
