<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="CApprovalSearch.aspx.cs" Theme="Blue" Inherits="BrilliantWMS.Account.CApprovalSearch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function selectedRec() {
            var hdnApproverSearchSelectedRec = window.opener.document.getElementById("hdnCenterApproName");
            var hdnApproversearchId = window.opener.document.getElementById("hdnCenterApproID");
