<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="ClientMaster.aspx.cs" 
    Inherits="BrilliantWMS.Account.ClientMaster" EnableEventValidation="false" %>
    ...
    <asp:UpdatePanel ID="UpdatePanelTabPanelCompanyList" runat="server">
        <ContentTemplate>
            <asp:TabContainer runat="server" ID="tabAccountMaster" ActiveTabIndex="1" Width="100%">
                <asp:TabPanel ID="TabCustomerList" runat="server" HeaderText="Client List" TabIndex="1">
                    <ContentTemplate>
                                                ...
                                                <obout:Grid ID="GvCustomer" runat="server" AllowAddingRecords="False" AllowFiltering="True"
                                                    ...
                                                    <Columns>
                                                        <obout:Column ID="Column1" AllowFilter="False" TemplateId="imgBtnEdit1" Index="1"
                                                         ...
                                                         <obout:Column DataField="ID" HeaderText="ID" Width="15%" Index="7" Visible="False">
                                                        </obout:Column>
                                                        <obout:Column DataField="Name" HeaderText="Client Name" Width="15%" Index="2">
                                                        </obout:Column>
                                                         <obout:Column DataField="Code" HeaderText="Code" Width="15%" Index="2">
                                                        </obout:Column>
                                                        <obout:Column DataField="Company" HeaderText="Company" Width="15%" Index="3">
                                                        </obout:Column>
                                                        <obout:Column DataField="Customer" HeaderText="Customer" Width="10%" Index="4">
                                                        </obout:Column>
                                                        <obout:Column DataField="Active" HeaderText="Active" Width="10%" Index="5">
                                                        </obout:Column>
                ...
                <asp:TabPanel ID="tabAccountInfo" runat="server" HeaderText="Client Info" TabIndex="2">
                    <ContentTemplate>
                        <center>
                            <table class="tableForm">
                                 <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList runat="server" ID="ddlcompany" Width="206px" D DataValueField="ID" DataTextField="Name" onchange="GetCustomer()" ValidationGroup="Save">
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="reqtxt_custname" runat="server" ErrorMessage="Enter Client Name"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddl_FinancialYr" runat="server" Width="206px">
                                            ...
                                            <asp:ListItem Text="2015-2016" Value="2011-2012"></asp:ListItem>
                                            <asp:ListItem Text="2016-2017" Value="2011-2012"></asp:ListItem>
                                            <asp:ListItem Text="2017-2018" Value="2011-2012"></asp:ListItem>
                                        </asp:DropDownList>
                ...
                <asp:TabPanel ID="tabAttachedDocumentInfo" runat="server" HeaderText="Document" TabIndex="6">
                    <ContentTemplate>
                                        ...
                                        <obout:Grid ID="grdratecard" runat="server" CallbackMode="true" Serialize="true"
                                            ...
                                            <Columns>
                                                ...
                                                <obout:Column DataField="RateDetails" HeaderText="Rate Details" Align="Center" HeaderAlign="center" Width="15%">
                                                 ...
                                                 <obout:Column DataField="Rate" HeaderText="Rate" Align="Center" HeaderAlign="center" Width="15%">
                                                </obout:Column>
