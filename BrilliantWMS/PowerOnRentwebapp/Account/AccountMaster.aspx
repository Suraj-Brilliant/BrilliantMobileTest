<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="AccountMaster.aspx.cs" Inherits="BrilliantWMS.Account.AccountMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <center>
        <asp:TabContainer runat="server" ID="tabAccountMaster" ActiveTabIndex="2" Width="100%">
            <asp:TabPanel ID="TabCustomerList" runat="server" HeaderText="Company List">
                <ContentTemplate>
                                    ...
                                    <table style="width: 100%">
                                        <tr>
                                            <td style="text-align: left;">
                                                <a id="headerText">
                                                    <asp:Label ID="lblheasertext" runat="server" Text="Company List"></asp:Label></a>
                                            </td>
                                ...
                                <td>
                                    <obout:Grid ID="GvCustomer" runat="server" AutoGenerateColumns="False" AllowAddingRecords="False"
                                        ...
                                        <Columns>
                                            ...
                                            <obout:Column DataField="Name" HeaderText="Company Name" Width="20%" Index="2">
                                            </obout:Column>
                                            <obout:Column HeaderText="Address Line 1" DataField="AddressLine1" Width="20%" Index="3">
                                            </obout:Column>
                                            <obout:Column HeaderText="City" DataField="City" Width="10%" Index="4">
                                            </obout:Column>
                                            <obout:Column DataField="PhoneNo" HeaderText="Phone No" Width="10%" Index="5">
                                            </obout:Column>
                                            <obout:Column DataField="EmailID" HeaderText="Email ID" Width="15%" Index="6">
                                            </obout:Column>
            ...
            <asp:TabPanel ID="tabAccountInfo" runat="server" HeaderText="Company Info">
                <ContentTemplate>
                    <center>
                        <table class="tableForm">
                            <tr>
                                <td>
                                    <req>
                                    <asp:Label Id="lblcustname" runat="server" Text="Company Name"></asp:Label>
                                    </req>
                                    :
                                </td>
                                <td>
                                ...
                                <td>
                                    <req><asp:Label Id="lblemailid" runat="server" Text="Email ID"/>
</req>
                                    :
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="auto-style1">
                                    <asp:Button ID="btncustomernext" runat="server" Visible="false" Text="  Next  " OnClick="btncustomernext_Click"
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">
                                   <asp:DropDownList ID="ddlsubscription" ClientIDMode="Static" DataTextField="Value" DataValueField="Id" runat="server" Width="206px" onchange="GetSubscription();">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ForeColor="Maroon" ControlToValidate="ddlsubscription"
    ...
    <%-- <script type="text/javascript">
        ...
        function selectRec() {
            ...
            for (i = 0; i < GvCustomer.PageSelectedRecords.length; i++) {
                var record = GvCustomer.PageSelectedRecords[i];
            ...
            var hdnselectedRecPayment = document.getElementById("hdnselectedRecPayment");
            hdnselectedRecPayment.value = "";
            for (i = 0; i < GvCustomer.PageSelectedRecords.length; i++) {
                var record = GvCustomer.PageSelectedRecords[i];
                if (hdnselectedRecPayment.value != "") hdnselectedRecPayment.value += ',' + record.Payment;
                if (hdnselectedRecPayment.value == "") hdnselectedRecPayment.value = record.Payment;
            }
            // alert(hdnselectedRecPayment.value);
        }

        function GvCustomer_Deselect(index) {
            selectRec();
        }
        ...
        function SetUserNmPass() {

            var formno = document.getElementById("<%=txtFormNum.ClientID %>").value;
            ...
            var usernm = document.getElementById("<%= txtUserName.ClientID %>");
            usernm.value = fname + '.' + lname;

            var passwrd = document.getElementById("<%= txtPassword.ClientID %>");
            //passwrd.value = lname + '.' + formno;
            passwrd.value = lname + '.' + mobileno;
        }

        //Add by Suresh For Payment Booking
        function selectedRecordBookPayment() {
            var hdnselectedRec = document.getElementById("hdnselectedRec");
            ...
            if (hdnselectedRec.value == "") {
                ...
                PageMethods.WMGetPaymentStatus(hdnselectedRecPayment.value, OnSuccessPaymentStatus, null);
            }
        }

        function OnSuccessPaymentStatus(result) {
            if (parseInt(result) > 0) {
                alert('Select Only Not Paid Payment Student');
                // GvCustomer.refresh();
            } else {
                var hdnselectedRec = document.getElementById("hdnselectedRec");
                window.open('../Account/BookPayment.aspx?stud=' + hdnselectedRec.value + '', null, 'height=200, width=700,status= 0, resizable= 1, scrollbars=0, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
            }
        }

        function selectedRecordSendMail() {
            var hdnselectedRec = document.getElementById("hdnselectedRec");
            var hdnselectedRecPayment = document.getElementById("hdnselectedRecPayment");
            if (hdnselectedRec.value == "") {
                alert('Select At Least 1 Student');
            } else {
                PageMethods.WMGetPaymentStatusSendMail(hdnselectedRecPayment.value, OnSuccessPaymentStatusSendMail, null);
            }
        }

        function OnSuccessPaymentStatusSendMail(result) {
            if (parseInt(result) > 0) {
                alert('Select Only Confirm Payment Student');
            } else {
                var hdnselectedRec = document.getElementById("hdnselectedRec");
                //alert(hdnselectedRec.value);
                PageMethods.WMSendUserNamePasswordofStudent(hdnselectedRec.value, OnsuccessSendUserNamePasswordofStudent, null)
            }
        }

        function OnsuccessSendUserNamePasswordofStudent(result) {
            if (parseInt(result) > 0) {
                alert('User Name & Password of Selected Student Send Successfully to Your Email Id.');
                //deselectAll(GvCustomer);
                // document.getElementById("hdnselectedRec").value = "";
            }
        }

        function GvCustomer_Deselect(index) {
            selectedRecordSendMail();
        }
        ...
        //            var coupenno = document.getElementById("<%=txtcoupen.ClientID %>").value;
        //            if (coupenno == "") {
        //                alert("Enter Coupen Number");
        //                document.getElementById("<%=txtcoupen.ClientID %>").focus();
        //            }
        //            else {
        //                PageMethods.WMCheckCoupon(coupenno, OnsuccessCoupen, OnFailCoupen);
        //            }

        //        }
        //        function OnsuccessCoupen(result) {
        ...
        //        }
        //        function OnFailCoupen() {
        //            showAlert("Error On Get Coupen!", "error", "#");
        //        }
