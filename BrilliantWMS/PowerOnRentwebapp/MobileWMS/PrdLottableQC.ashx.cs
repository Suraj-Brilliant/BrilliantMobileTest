...
{
    /// <summary>
    /// Summary description for PrdLottableQC
    /// </summary>
    public class PrdLottableQC : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            cmd.CommandText = "select * from tskutransactionhistory where finalzone='GRN' and oid=" + Oid + " and lottable1='" + prdBarcode + "'";
            cmd.Connection = conn;
