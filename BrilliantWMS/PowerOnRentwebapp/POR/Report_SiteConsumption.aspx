<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    CodeBehind="Report_SiteConsumption.aspx.cs" Inherits="WebClientElegantCRM.POR.Report_SiteConsumption" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <script type="text/javascript">
        function checkboxcheck() {
            var ddl1 = document.getElementById("<%= chkEngineList.ClientID %>");
            var chkAllSite = document.getElementById("<%= chkAll.ClientID %>");
        ...
        function checkboxcheck2() {
            var ddl1 = document.getElementById("<%= chkProductLst.ClientID %>");
            var chkAllSite = document.getElementById("<%= chkAllPrd.ClientID %>");
            var Lengtha = ddl1.getElementsByTagName("input").length;
            var allInput = ddl1.getElementsByTagName("input");
            var checkedcount = 0;
            for (var i = 0; i <= Lengtha - 1; i++) {
                ...
                <table>
                        ...
                        <td>
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <ucd:UC_Date ID="FrmDate" runat="server" />
                                    </td>
                                    <td>
                            ...
                            <div class="acc-section">
                                <div class="acc-content" style="margin: 0px 0px 5px 5px;">
                                    <asp:DropDownList ID="ddlSite" runat="server" DataValueField="ID" DataTextField="Territory"
                                        Width="200px" AutoPostBack="true" ClientIDMode="Static" OnSelectedIndexChanged="ddlSite_SelectedIndexChanged"
                                        onchange="div1(this);">
                                    </asp:DropDownList>
                                </div>
                            </div>
                                    ...
                                    <div class="acc-section">
                                        <div class="acc-content">
                                            ...
                                            <asp:CheckBoxList ID="chkEngineList" runat="server" RepeatDirection="Horizontal"
                                                onclick="checkboxcheck()" DataValueField="EngineSerial" DataTextField="EngineSerial"
                                                RepeatColumns="10">
                                            </asp:CheckBoxList>
                                            <br />
                                            <asp:Button ID="btnPrd" runat="server" Text="Select Product" OnClick="btnPrd_Click"
                                                onblur="readCheckBoxList();" CausesValidation="false" />
                                        </div>
                                    </div>
                                </li>
                            </ul>
                        ...
                        <td>
                            <ul class="acc" id="acc">
                                <li>
                                    ...
                                    <div class="acc-section">
                                        <div class="acc-content">
                                            <asp:CheckBox ID="chkAllPrd" runat="server" Text="Select All" onclick="checkallProduct()" /><hr />
                                            <br />
                                            <asp:CheckBoxList ID="chkProductLst" runat="server" RepeatDirection="Horizontal"
                                                onclick="checkboxcheck2()" DataValueField="Name" DataTextField="Name" RepeatColumns="10">
                                            </asp:CheckBoxList>
                                            <br />
                           ...
                           <h3 style="margin-left: 5px; color: #033;">
                            ...
                            <div class="acc-section">
                                 <div class="acc-content" style="margin: 0px 0px 5px 5px;">
                                       ...
                                       <asp:CheckBox ID="chkConsumable" runat="server" Text="With Consumable" />
                                       <asp:CheckBox ID="chkpartwise" runat="server" Text="Part Wise Consumption Summary" />
                                 </div>
                            </div>
                       </td>
                    </tr>
                    <tr>
                        <td>
                           <div class="acc-section">
                               <div class="acc-content">
                                    <asp:Button ID="btnSubmit" runat="server" Text="View Report" OnClick="btnSubmit_Click"
