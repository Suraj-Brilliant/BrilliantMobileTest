...
{
    public partial class ImportVReturn : System.Web.UI.Page
    {
        ResourceManager rm;
        CultureInfo ci;
        DataTable dt;
        ...
        protected void btnnext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect("ImportFReturn.aspx");
            }
            catch
            {
        ...
        protected void btnback_Click(object sender, EventArgs e)
        {
            ...
            productClient.DeleteOrderImport(profile.DBConnection._constr);
            productClient.Close();
            Response.Redirect("ImportDReturn.aspx");
        }
