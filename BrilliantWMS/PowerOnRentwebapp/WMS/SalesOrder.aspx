<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="SalesOrder.aspx.cs"
    Inherits="BrilliantWMS.WMS.SalesOrder" EnableEventValidation="false" Theme="Blue" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <center>
            ...
            <div id="OrderHead" runat="server" clientidmode="Static">
                <table class="tableForm">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <asp:TextBox ID="txtClientName" runat="server" MaxLength="100" Width="171px" ClientIDMode="Static"></asp:TextBox>
                            <a id="btnSelectAccount" onclick="openClientSearchWindow()">
                                <img src="../App_Themes/Blue/img/SelectAccount16.png" style="margin-bottom: -4px; cursor: pointer;" />
                            </a>
                            <%--<asp:DropDownList runat="server" ID="ddlCompany" Width="182px" DataTextField="Name"
                                DataValueField="ID" ClientIDMode="Static" onchange="GetClnt(this);GetContact1(this); ">
                            </asp:DropDownList>--%>
                        </td>
                        <td style="text-align: right;">
                            <asp:Label ID="lblDepartment" runat="server" Text="Store"></asp:Label>
                            :
                        </td>
                        <td style="text-align: left;">
                        ...
                        <td style="text-align: right;">
                            <asp:Label ID="lblContact1" runat="server" Text="Default Contact*"></asp:Label>
                            :
                        </td>
                        <td style="text-align: left;">
                            ...
                            <asp:TextBox ID="txtContact1" runat="server" Width="182px" Enabled="false" ></asp:TextBox> <%--AccessKey="1"--%>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <asp:Label ID="lblCustomerAddress" runat="server" Text="Alternate Delivery Address"></asp:Label>
                            :
                        </td>
                        <td style="text-align: left;">
                                ...
                                <asp:UpdatePanel ID="UpdLst" runat="server">
                                    <ContentTemplate>
                                        <asp:ListView ID="LstStatutoryInfo" runat="server" GroupItemCount="3" Style="margin-bottom: 0px; width: 1000px">
                                            <%--OnLoad="LstStatutoryInfo_OnLoad"--%>
                                            <GroupTemplate>
                        ...
                        <td>
                            <obout:Grid ID="Grid1" runat="server" CallbackMode="true" Serialize="true" AllowColumnReordering="true"
                                ...
                                <Columns>
                                    ...
                                    <%--8 new--%>
                                    <obout:Column DataField="RequestQty" Width="14%" HeaderAlign="center" HeaderText="Request Quantity" Wrap="true"
                                        Align="center" AllowEdit="false">
                                        <TemplateSettings TemplateId="PlainEditTemplate" />
                                    </obout:Column>
                                    <%--9 new--%>
                                    <obout:Column DataField="ReturnQty" Width="0%" HeaderAlign="center" HeaderText="Return Quantity" Wrap="true"
                                        Align="center" AllowEdit="false" Visible="false">
                                        <TemplateSettings TemplateId="TemplateReturn" />
                                    </obout:Column>
                                    <%--10 new--%>
                                ...
                                <Templates>
                                    ...
                                    <obout:GridTemplate ID="TemplateReturn" runat="server">
                                        <Template>
                                            <div class="divTxtPrice">
                                                <asp:TextBox ID="txtReturnQty" Width="94%" Style="text-align: right;" runat="server" onkeydown="AllowDecimal(this,event);"
                                                    onkeypress="AllowDecimal(this,event);" Text="<%# Container.Value %>"></asp:TextBox>
                                            </div>
                                        </Template>
                                    </obout:GridTemplate>
        ...
        <asp:HiddenField ID="hdnselectedCont1" runat="server" ClientIDMode="Static" Value="0"/>
        ...
        <asp:HiddenField ID="hdnSelectedClnt" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="hdnSelectedClntName" runat="server" ClientIDMode="Static" />
    </center>
    <script type="text/javascript">
        onload();
        function onload() {
    ...
    <script type="text/javascript">
        function openClientSearchWindow() {
            window.open('../WMS/ClientList.aspx', null, 'height=600px, width=742px,status= 0, resizable= 0, scrollbars=1, toolbar=0,location=0,menubar=0,');
        }

        function getClientInfo(clientID, clientName) {
            var hdnSelectedClnt = document.getElementById("hdnSelectedClnt");
            var hdnSelectedClntName = document.getElementById("hdnSelectedClntName");
            hdnSelectedClnt.value = clientID;
            hdnSelectedClntName.value = clientName;
            var txtClientName = document.getElementById("<%=txtClientName.ClientID %>");
            txtClientName.value = clientName;

            PageMethods.WMGetVendorSession(clientID);
        }
        /*Approval JS*/
    ...
    <script type="text/javascript">
            ...
            if (validate == true) {
                ...
                if (Grid1.Rows.length == 0) {
                    ...
                    if (isContainsZero != 'yes' && isContnZro != 'yes') {
                        ...
                        // obj1.ClntID = parseInt(ddlCompany.options[ddlCompany.selectedIndex].value);
                        var ClntID = txtClientName.value.toString();
                        ...
                        // SavePaymentMethod();
                        PageMethods.WMSaveRequestHead(obj1,ClntID, WMSaveRequestHead_onSuccessed, WMSaveRequestHead_onFailed);
        ...
        function WMSaveRequestHead_onSuccessed(result) {
            ...
            if (result == 0 || result == 0) { showAlert("Order Generation Failed. Please Check the Order Input and Department Configurations...", "Error", '../WMS/Outbound.aspx'); }
            else if (result >= 1) {
                //"Request saved successfully"
                hdnNewOrderID.value = result;
                SavePaymentMethod();
                showAlert("Request saved successfully", "info", "../WMS/Outbound.aspx");
            } else if (result == -5) {
                showAlert("Client with same name already exist. Please select from client list...", "error", "../WMS/SalesOrder.aspx");
            }
            else if (result == -3) {
                showAlert("Request saved successfully. Email Notification Failed...", "info", "../WMS/Outbound.aspx");
            }
            else {
                ...
                showAlert("Request Edited Successfully", "info", "../WMS/Outbound.aspx");
            }
        }

        function WMSaveRequestHead_onFailed() { showAlert("Error occurred", "Error", "../WMS/Outbound.aspx"); }
        ...
        function GetPaymentMethodDetails() {
            ...
            function GetIndex(myDD, myHdnUMO, mySpnTotalQty, usrInputQty, crntStock, Index, Price, TotPrice, TotalTaxPrice, rowTotalTax, moq) {
            ...
            function GetIndexQty(myDD, myHdnQty, myHdnUMO, mySpnTotalQty, usrInputQty, crntStock, Index, Price, TotPrice, TotalTaxPrice, rowTotalTax, moq) {
                var hdnSelectedQty = document.getElementById('hdnSelectedQty');
...
function GetChangedPrice(myTxt, myHdnQty, myHdnUMO, mySpnTotalQty, usrInputQty, crntStock, Index, TotPrice, TotalTaxPrice, rowTotalTax, ProdID) {
...
function GetReturnQty(myTxt, usrInputQty, Index) {
    var hdnEnteredQty = document.getElementById('hdnEnteredQty');
    var eq = hdnEnteredQty.value;
    var enterQty = myTxt.value;
    hdnEnteredQty.value = myTxt.value;
    var getUserInputQtyObj = document.getElementById(usrInputQty);

    if (enterQty > getUserInputQtyObj.value) {
        myTxt.value = getUserInputQtyObj.value;
        showAlert("Return Quantity is greater than Request Quantity...!!!", "Error", '#');
    } else {
        var order = new Object();
        order.Sequence = Index + 1;
        order.ReturnQty = enterQty;
        PageMethods.WMUpdReturnQty(order, null, null);
    }
}
...
function WMSaveTemplateHead_onFailed() { showAlert("Error occurred", "Error", "#"); }
    ...
    <script type="text/javascript">
        ...
        function GetClnt() {
            //
            //var hdnSelectedClnt = document.getElementById('hdnSelectedClnt');
            //hdnSelectedClnt.value = ddlCompany.value;
        ...
        function openContactSearch2(sequence) {
            window.open('../PowerOnRent/AddEditSearchContact.aspx?inv=Warehouse&Con=2', null, 'height=500px, width=825px,status= 0, resizable= 1, scrollbars=1, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
        }
        ...
        function AfterLocationSelected(LocID, LocName, LocConID, LocConNM, LocationName) {
            ...
            txtLocation.value = LocName + ' ' + LocationName;
        ...
        function OnsuccessGetTotalFortax(result) {
            ...
            if (cartsequence != 0) {
                ...
                window.open('../Tax/ApplyTax.aspx?CartSeq=' + cartsequence + '&Object=SalesOrderTax&TaxableAmt=' + TaxableAmount + '&PrdID=' + PrdID + '', null, 'height=700px, width=660px,status= 0, resizable= 0, scrollbars=0, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
            }
            if (cartsequence == 0) {
                var lblSubTotal2 = document.getElementById("<%= lblSubTotal2.ClientID %>");
                TaxableAmount = parseFloat(lblSubTotal2.innerHTML).toFixed(2);
                window.open('../Tax/ApplyTax.aspx?CartSeq=' + cartsequence + '&Object=SalesOrderTotalTax&TaxableAmt=' + TaxableAmount + '&PrdID=' + PrdID + '', null, 'height=700px, width=660px,status= 0, resizable= 0, scrollbars=0, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
            }
