<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="ImportFTransfer.aspx.cs" Inherits="BrilliantWMS.WMS.ImportFTransfer" Theme="Blue" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <div class="divHead" id="divRequestHead">
        <h4>
            <asp:Label ID="lblHeading" runat="server" Text="Import Transfer"></asp:Label></h4>
    </div>
            ...
            <table>
                <tr>
                    <td class="tdCartStepHolder">
                        <span class="cartStepHolder"><span class="cartStepTitle"><span class="divCartSymbol">1</span><asp:Label ID="lblstep1" runat="server" Text="Upload File"></asp:Label></span><span class="cartStepTitle"><span class="divCartSymbol">2</span>
                            <asp:Label ID="lblstep2" runat="server" Text="Data Validation & Verification"></asp:Label></span><span class="cartStepTitle cartStepCurrentTitle"><span
                                class="divCartSymbol divCartCurrentSymbol">3</span><asp:Label ID="lblstep3" runat="server" Text="Finished"></asp:Label></span></span>
                    </td>
                </tr>
                <tr>
                    <td colspan="4">
                ...
                <tr>
                    <td>
                        <span>
                            <h1>Data Importing Successfully Finished!
                            </h1>
                        </span>
                    </td>
                </tr>
