<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="QualityControl.aspx.cs"
    Inherits="BrilliantWMS.WMS.QualityControl" EnableEventValidation="false" Theme="Blue" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    <asp:UpdatePanel ID="UPTBQCList" runat="server">
        <ContentTemplate>
            <asp:TabContainer ID="TCQC" runat="server">
                <asp:TabPanel ID="TabQCList" runat="server" HeaderText="Quality Check List">
                    <ContentTemplate>
                        <asp:UpdateProgress ID="UPGRNGridProgress" runat="server" AssociatedUpdatePanelID="UpPnlGridQC">
                            <ProgressTemplate>
                                <center>
                                    <div class="modal">
                        ...
                        <asp:UpdatePanel ID="UpPnlGridQC" runat="server">
                            <ContentTemplate>
                                <%--<div class="divHead">--%>
                                ...
                                <div id="divlinkQCList">
                                    ...
                                    <center>
                                        <table class="gridFrame" width="100%">
                                            <tr>
                                                <td>
                                                    <table style="width: 100%">
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblqclist" Style="color: white; font-size: 15px; font-weight: bold;" runat="server" Text="Quality Check List"></asp:Label>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <obout:Grid ID="grdQC" runat="server" AAllowAddingRecords="false" AutoGenerateColumns="false" AllowColumnResizing="true" AllowFiltering="true"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <obout:Column DataField="GRNID"  HeaderAlign="center" Align="center" Width="5%"></obout:Column>
                                                            <obout:Column DataField="PONO" HeaderText="Order No" HeaderAlign="center" Align="center" Width="7%"></obout:Column>
                                                            ...
                                                            <obout:Column DataField="VendorName"  HeaderAlign="left" Align="left" Width="10%" Wrap="true"></obout:Column>
                                                            ...
                                                            <obout:Column DataField="ImgQC" HeaderText="Quality Check" HeaderAlign="center" Align="center" Width="7%">
                                                                <TemplateSettings TemplateId="QCStatusQC" />
                                                            </obout:Column>
                                                            <obout:Column DataField="ImgLP" HeaderText="Label Printing" HeaderAlign="center" Align="center" Width="7%">
                                                                <TemplateSettings TemplateId="QCStatusLP" />
                                                            </obout:Column>
                                                            <obout:Column DataField="ImgPutIn" HeaderText="Put In" HeaderAlign="center" Align="center" Width="7%">
                                                                <TemplateSettings TemplateId="QCStatusPI" />
                                                            </obout:Column>
                                                            <obout:Column DataField="ImgDis" HeaderText="Dispatch" HeaderAlign="center" Align="center" Width="7%">
                                                                <TemplateSettings TemplateId="QCStatusDispatch" />
                                                            </obout:Column>
                                                        </Columns>
                                                        <Templates>
                                                            <obout:GridTemplate ID="QCStatusQC" runat="server">
                                                                <Template>
                                                                    <center>
                                                            ...
                                                            <obout:GridTemplate ID="QCStatusLP" runat="server">
                                                                <Template>
                                                                    <center>
                                                                        <div class='<%# ("POR" + Container.Value) %>' onclick="LabelPrintingOpenEntryForm('LabelPrinting','<%# Container.Value %>', '<%# Container.DataItem["ID"] %>','<%# Container.DataItem["GRNID"] %>')"></div>
                                                                    </center>
                                                                </Template>
                                                            </obout:GridTemplate>
                                                            <obout:GridTemplate ID="QCStatusPI" runat="server">
                                                                <Template>
                                                                    <center>
                                                            ...
                                                            <obout:GridTemplate ID="QCStatusDispatch" runat="server">
                                                                <Template>
                                                                    <center>
            ...
            <asp:HiddenField ID="hdnSelectedGRNRec" runat="server" ClientIDMode="Static" />
        </ContentTemplate>
    </asp:UpdatePanel>
    <script type="text/javascript">
        ...
        function SelectedRec() {
            ...
            if (grdQC.PageSelectedRecords.length > 0) {
                for (var i = 0; i < grdQC.PageSelectedRecords.length; i++) {
                    var record = grdQC.PageSelectedRecords[i];
        ...
        function LabelPrintingOpenEntryForm(invoker, state, QCID, GRNID) {
            var hdnSelectedGRNRec = document.getElementById('hdnSelectedGRNRec');
            hdnSelectedGRNRec.value = GRNID;
            if (state != "gray") {
                if (state == "red") { state = "Edit"; }
                else if (state != "red") { state = "View"; }
                PageMethods.WMSetSessionQC(invoker, QCID, state, LabelPrintingOpenEntryFormOnSuccess, null);
            }
            else {
                showAlert("Not Applicable", '', '#');
            }
        }
        function LabelPrintingOpenEntryFormOnSuccess(result) {
            switch (result) {
                case "LabelPrinting":
                    var hdnSelectedGRNRec = document.getElementById('hdnSelectedGRNRec');
                    window.open('../WMS/LabelPrinting.aspx?ID=' + hdnSelectedGRNRec.value + '', '_self', '');
                    break;
            }
        }
        ...
        function RequestOpenEntryFormOnSuccess(result) {
            switch (result) {
                ...
                case "QC":
                    ...
                    break;
                case "LabelPrinting":
                    window.open('../WMS/LabelPrinting.aspx', '_self', '');
                    break;
                case "Receipt":
        ...
        function OpenCreditNote() {
            window.open('../WMS/CreditNote.aspx', null, 'height=450px, width=825px,status= 0, resizable= 1, scrollbars=1, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
        }
        function OpenDebitNote() {
            window.open('../WMS/DebitNote.aspx', null, 'height=450px, width=825px,status= 0, resizable= 1, scrollbars=1, toolbar=0,location=center,menubar=0, screenX=300; screenY=50');
        }
        function CreateTask() {
            var hdnSelectedRec = document.getElementById('hdnSelectedRec');
