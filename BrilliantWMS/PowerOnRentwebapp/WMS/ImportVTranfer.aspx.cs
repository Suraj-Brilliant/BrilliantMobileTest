...
{
    public partial class ImportVTranfer : System.Web.UI.Page
    {
        ResourceManager rm;
        CultureInfo ci;
        DataTable dt;
        ...
        public void DisplayGrid()
        {
            ...
            if (value == 0)
            {
                ...
                lblbackMessage.Text = "Colored Row SKU not Available in WMS.Please click on Back Button";
            }
            else if (value == 2)
            {
                btnnext.Enabled = false;
        ...
        protected void btnnext_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect("ImportFTransfer.aspx");
            }
            catch
            {
        ...
        protected void btnback_Click(object sender, EventArgs e)
        {
            ...
            productClient.DeleteOrderImport(profile.DBConnection._constr);
            productClient.Close();
            Response.Redirect("ImportDTransfer.aspx");
        }
