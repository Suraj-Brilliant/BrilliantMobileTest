<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="CreditNote.aspx.cs" 
    Inherits="BrilliantWMS.WMS.CreditNote" EnableEventValidation="false" Theme="Blue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
         <asp:UpdateProgress ID="UpdateProgress_CreditNote" runat="server" AssociatedUpdatePanelID="updPnl_CreditNote">
            <ProgressTemplate>
                <center>
                    <div class="modal">
          ...
          <asp:UpdatePanel ID="updPnl_CreditNote" runat="server">
            <ContentTemplate>
                <table class="tableForm" id="tblCreditNote" runat="server">
                    <tr>
                        <td>
                    ...
                    <tr>    
                        <td>
                            <asp:Label ID="lblDate" runat="server" Text="Credit Note Date"></asp:Label>:
                        </td>
                        <td style="text-align: left">
                            <uc3:UC_Date ID="UCCreditDate" runat="server" />
                        </td>                   
                        <td>
                        ...
                        <td>
                            <obout:Grid ID="grdSkuList" runat="server" AutoGenerateColumns="False" AllowAddingRecords="False"
                                ...
                                <Columns>
                                    ...
                                    <obout:Column DataField="GRNQty" HeaderText="Received Qty" AllowEdit="false" Width="11%" Wrap="true"
                                        HeaderAlign="center" Align="center">
                                         <%--<TemplateSettings TemplateId="PlainEditTemplate" />--%>
                                    </obout:Column>
                                     <obout:Column DataField="RemaningQty" HeaderText="Credit Note Qty" AllowEdit="false" Width="11%" Wrap="true"
                                        HeaderAlign="center" Align="center">
                                    </obout:Column>
                ...
                <table>
                    <tr>
                        <td style="text-align: right;">
                            <input type="button" id="btnSaveCN" title="Save" runat="server" value="Save" onclick="saveCreditNote();" />
