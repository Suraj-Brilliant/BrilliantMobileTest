<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddressInfo.aspx.cs" Inherits="PowerOnRentwebapp.Address.AddressInfo" %>
                    ...
                    <td style="background-color: White;" colspan="2">
                        <table class="tableForm" style="border: none; width: 970px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlCountry" ClientIDMode="Static" runat="server" onchange="print_state('ddlState',this.selectedIndex); printZone(); printSubZone(); CheckDuplicateAddress();"
                                        Width="211px">
                                    </asp:DropDownList>
