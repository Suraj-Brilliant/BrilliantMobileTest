<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="DesignationMaster.aspx.cs" Inherits="BrilliantWMS.UserManagement.DesignationMaster" %>
                ...
                <table class="tableForm">
                    <tr>
                         ...
                         <td>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="rqvalcustomer" ForeColor="Maroon" ControlToValidate="ddlcustomer"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:DropDownList ID="ddlDepartment" runat="server" Width="206px" DataTextField="Name" DataValueField="ID" onchange="GetDepartmentID()">
                            </asp:DropDownList>
                        ...
                        <td>
                            <obout:Grid ID="gvDesignationM" runat="server" AllowAddingRecords="false" AllowFiltering="true"
                                ...
                                <Columns>
                                    ...
                                    <obout:Column DataField="DepartmentID" HeaderText="DepartmentID" Width="1%" Visible="false">
                                    </obout:Column>
                                </Columns>
                                <Templates>
