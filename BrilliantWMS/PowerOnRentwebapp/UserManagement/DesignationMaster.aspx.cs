    ...
    public partial class DesignationMaster : System.Web.UI.Page
    {
        ...
        public void BindGrid()
        {
            try
            {
                ...
                gvDesignationM.DataSource = DesignationClient.GetDesignationListTOBindgrid(profile.DBConnection._constr);
        ...
        public void BinddlDepartment()
        {
            try
            {
                ...
                ddlDepartment.DataSource = DepartmentClient.GetDeptByCustomerID(long.Parse(hdncustomerid.Value), profile.DBConnection._constr);
        ...
        protected void gvDesignationM_Select(object sender, Obout.Grid.GridRecordEventArgs e)
        {
            try
            {
                ...
                hdndepartment.Value = selectedrec["DepartmentID"].ToString();
