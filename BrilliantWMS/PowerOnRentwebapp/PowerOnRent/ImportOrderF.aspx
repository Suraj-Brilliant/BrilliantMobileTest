<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="ImportOrderF.aspx.cs" 
    Inherits="BrilliantWMS.PowerOnRent.ImportOrderF" Theme="Blue" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <div class="divHead" id="divRequestHead">
        <h4><asp:Label ID="lblHeading" runat="server" Text="Import Sales Order"></asp:Label></h4>
    </div>
                ...
                <tr>
                    <td class="tdCartStepHolder">
                        <span class="cartStepHolder"><span class="cartStepTitle"><span class="divCartSymbol">
                            1</span><asp:Label ID="lblstep1" runat="server" Text="Upload File"></asp:Label></span><span class="cartStepTitle"><span class="divCartSymbol">2</span>
