<%@ Page Title="Power On Rent | Transfer From Site" Language="C#" MasterPageFile="~/MasterPage/CRM.Master"
    AutoEventWireup="true" CodeBehind="TransferFromSiteOLD.aspx.cs" Inherits="BrilliantWMS.PowerOnRent.TransferFromSite"  %>
        ...
        function jsSaveData() {
            ...
            if (validate == false) {
                ...
                if (ddlStatus.options[ddlStatus.selectedIndex].text == "Transfer" && Grid1.Rows.length == 0) {
                    ...
                    obj1.TransferdByUserID = ddlTransferedBy.options[ddlTransferedBy.selectedIndex].value;
