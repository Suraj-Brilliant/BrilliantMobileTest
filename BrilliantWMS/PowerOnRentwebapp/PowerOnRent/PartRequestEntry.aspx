<%@ Page Title="GWC | Request" Language="C#" MasterPageFile="~/MasterPage/CRM.Master"
    AutoEventWireup="true" CodeBehind="PartRequestEntry.aspx.cs" Inherits="BrilliantWMS.PowerOnRent.PartRequestEntry"
            ...
            <div id="OrderHead" runat="server" clientidmode="Static">
                <table class="tableForm">
                    ...
                    <td style="text-align: right;">
                        <asp:Label ID="lblFrmTemplate" runat="server" Text="Generate From Template"></asp:Label>
                        :
                    </td>
                    <td style="text-align: left;">
                        <input type="checkbox" id="chkSelectTemplate" onclick="OpenTelplateList();" runat="server" />

                    </td>
                    <td style="text-align: right;">
                        <asp:Label ID="lblTemplateTitleField" runat="server" Text="Template Title" ForeColor="Gray"></asp:Label>
                        :
                    </td>
                    <td style="text-align: left;">
                        <asp:Label ID="lblSelectedTemplateTitle" runat="server" Text="Not Available" ForeColor="Gray"></asp:Label>
                    </td>
                    <td></td>
                    <td style="text-align: right;">
                        <asp:Button ID="btnSaveAsTemplate" runat="server" Text="Save As Template" Style="cursor: pointer;" Visible="false" />
                        <asp:Panel ID="PanelTemplate" runat="server" align="center" Visible="false">
                            <table class="gridFrame" id="Table1" width="100%">
                                <tr>
                                    <td>
                                        <table width="100%">
                                            <tr>
                                                <td style="text-align: left;">
                                                    <asp:Label ID="lbltemplate" runat="server" CssClass="headerText" Text="New Template"
                                                        ForeColor="White"></asp:Label>
                                                </td>
                                                <td style="text-align: Left;">
                                                    <asp:Button ID="btnSubmitTemplate" runat="server" Text="Submit" Style="cursor: pointer;"
                                                        OnClientClick="SubmitTemplate()" />
                                                    //OnClick="btnSubmitTemplate_Onclick""
                                                    <asp:Button ID="btnCloseNewTemplate" runat="server" Text="Cancel" Style="cursor: pointer;" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table style="background-color: White;">
                                            <tr>
                                                <td style="color: Black; text-align: right;">
                                                    <asp:Label ID="lblTemplateTitle" runat="server" Text="Template Title"></asp:Label>
                                                    :
                                                </td>
                                                <td style="text-align: left;">
                                                    <asp:TextBox ID="txtTemplateTitle" runat="server" Width="180px">
                                                    </asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RFVTemplateTitle" runat="server" ErrorMessage="*"
                                                        ControlToValidate="txtTemplateTitle">
                                                    </asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="color: Black; text-align: right;">
                                                    <asp:Label ID="lblAccessType" runat="server" Text="Access Type"></asp:Label>
                                                    :
                                                </td>
                                                <td style="text-align: left;">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RFVAccessType" runat="server" ErrorMessage="*" ControlToValidate="ddlAccessType">
                                                    </asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                        ...
                        <asp:ModalPopupExtender ID="ModalPopupTemplate" runat="server" PopupControlID="PanelTemplate"
                            TargetControlID="btnSaveAsTemplate" CancelControlID="btnCloseNewTemplate" Drag="true" Enabled="false">
                ...
                <tr id="TrReq2">
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtFailureHours" MaxLength="6" Width="176px" AccessKey="0"
                            onkeypress="AllowInt(this,event);" onkeydown="AllowInt(this,event);">
                        </asp:TextBox>
                    </td>
                    <td>
                        Cause of Failure :
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtFailureCause" onkeyup="TextBox_KeyUp(this,'CharactersCounter1','100');"
                            ClientIDMode="Static" Width="176px" TextMode="MultiLine" AccessKey="0">
                        </asp:TextBox>
                        <br />
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="text-align: right;">
                                        ...
                                        <%--<asp:Panel ID="PanelProduct" runat="server" align="center" Visible="false">
                                                    ...
                                                    <table style="background-color: White;">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RFV2" runat="server" ErrorMessage="*" ControlToValidate="txtProductName">
                                                                </asp:RequiredFieldValidator>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RFV3" runat="server" ErrorMessage="*" ControlToValidate="txtDesc">
                                                                </asp:RequiredFieldValidator>
                                                            </td>
                                                        </tr>
                                                    </table>
                                        ...
                                        <asp:HiddenField ID="hdnprodID" runat="server" />
                                        <%-- <asp:modalpopupextender id="ModelPopup1" runat="server" popupcontrolid="PanelProduct"
...
function WMSaveRequestHead_onSuccessed(result) {
    ...
    if (result == 0 || result == 0) { showAlert("Order Generation Failed. Please Check the Order Input and Department Configurations...", "Error", '../PowerOnRent/Default.aspx?invoker=Request'); }
    else if (result >= 1) {
...
function GetIndex(myDD, myHdnUMO, mySpnTotalQty, usrInputQty, crntStock, Index, Price, TotPrice, moq) {
...
function GetIndexQty(myDD, myHdnQty, myHdnUMO, mySpnTotalQty, usrInputQty, crntStock, Index, Price, TotPrice, moq) {
    var hdnSelectedQty = document.getElementById('hdnSelectedQty');
...
function GetChangedPrice(myTxt, myHdnQty, myHdnUMO, mySpnTotalQty, usrInputQty, crntStock, Index, TotPrice, ProdID) {
