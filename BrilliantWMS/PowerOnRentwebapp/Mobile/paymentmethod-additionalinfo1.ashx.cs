...
namespace PowerOnRentwebapp.Mobile
{
    ...
    public class paymentmethod_additionalinfo : IHttpHandler
    {
        ...
        //public string GetPMAdditionInfo(string pmId)
        //{
        //    string addinfo="", FilterAddINFO="";
        //    SqlConnection conn = new SqlConnection(strcon);
        //    cmd.CommandType = CommandType.Text;
        //    cmd.Connection = conn;
        //    cmd.CommandText = "select * from mPaymentMethodDetail where PMethodID=" + pmId + "";
        ...
        //            addinfo = addinfo + ":";
        //            string FieldName = dt.Rows[i]["FieldName"].ToString();
        //            addinfo = addinfo + FieldName;
        //            addinfo = addinfo + ":";
        //            string ControlType = dt.Rows[i]["ControlType"].ToString();
        //            addinfo = addinfo + ControlType;
        //            addinfo = addinfo + ":";
        //            string Mandetory = dt.Rows[i]["Mandetory"].ToString();
        //            addinfo = addinfo + Mandetory;
        //            addinfo = addinfo + ":";
        //            string Query = dt.Rows[i]["Query"].ToString();
        //            addinfo = addinfo + Query;
        //            addinfo = addinfo + ":";
                    
        //        }
        //        FilterAddINFO=addinfo.Substring(0,(addinfo.Length-1));
        //    }

        //    return FilterAddINFO;
        //}
