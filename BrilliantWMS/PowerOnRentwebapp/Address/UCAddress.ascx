<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCAddress.ascx.cs" Inherits="BrilliantWMS.Address.UCAddress"
        ...
        <table class="gridFrame" style="width: 100%">
            <tr>
                <td style="text-align: left;">
                   <asp:Label class="headerText" ID="lbladdresslist" runat="server" Text="Address List"></asp:Label>
                </td>
                <td style="text-align: right;">
                    <input type="button" id="btnAddress" runat="server" value="Add New" onclick="openAddressWindow('0')" />
                   <%-- &nbsp;
                    ...
                    <obout:Grid ID="GvAddressInfo" runat="server" AutoGenerateColumns="false" AllowAddingRecords="false"
                        ...
                        <Columns>
                          <%--  <obout:CheckBoxSelectColumn AllowSorting="true" ControlType="Obout" Width="3%" Align="center"
                            ...
                            <%-- <obout:Column DataField="Zone" HeaderText="Contact 1" Width="10%">
                            </obout:Column>
                             <obout:Column DataField="SubZone" HeaderText="Contact 2" Width="10%">
                            </obout:Column>--%>
