<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="ImportPriceV.aspx.cs" 
    Inherits="BrilliantWMS.Product.ImportPriceV" Theme="Blue" %>
        ...
        <table>
                            ...
                            <tr>
                                <td class="tdCartStepHolder">
                                    <span class="cartStepHolder"><span class="cartStepTitle"><span class="divCartSymbol">
                                        1</span>Upload File</span><span class="cartStepTitle cartStepCurrentTitle"><span
                                            class="divCartSymbol divCartCurrentSymbol">2</span>Data Validation & Verification</span><span
                                                class="cartStepTitle"><span class="divCartSymbol">3</span>Finished</span></span>
                                </td>
                            </tr>
                        </table>
                    </center>
            ...
            <tr>
                <td style="text-align: left;">
                   <asp:Label class="headerText" ID="lbladdresslist" runat="server" Text="Import SKU Price"></asp:Label>
                </td>
                ...
                <td >
                    <obout:Grid ID="GVImportView" runat="server" AllowGrouping="true" Serialize="false"
                        ...
                        <Columns>
                            ...
                            <obout:Column DataField="SKUCode" HeaderText="SKU Code" HeaderAlign="center" Align="center" Width="9%">
                            </obout:Column>
                            <obout:Column DataField="Name" HeaderText="SKU Name" HeaderAlign="left" Align="left" Width="9%">
                            </obout:Column>
                            <obout:Column DataField="Description" HeaderText="SKU Description" HeaderAlign="left" Align="left" Width="20%">
                            </obout:Column>
                            <obout:Column DataField="Territory" HeaderText="Department" HeaderAlign="left" Align="left" Width="9%">
                            </obout:Column>
                             <obout:Column DataField="Price" HeaderText="Price" HeaderAlign="left" Align="left" Width="6%">
                            </obout:Column>
                            <obout:Column DataField="SKUCodechk" HeaderText="Product Code" HeaderAlign="left" Align="left" Width="9%" Visible="false">
                            </obout:Column>
