<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="SearchProduct.aspx.cs" Theme="Blue" Inherits="BrilliantWMS.Product.SearchProduct" %>
            ...
            <td>
                <obout:Grid ID="GridProductSearch" runat="server" AutoGenerateColumns="false" AllowFiltering="false"
                    ...
                    <Columns>
                        ...
                        <obout:Column DataField="ProductCode" HeaderText="WMS SKU Code" Align="left" HeaderAlign="left"
                            Width="13%" AllowFilter="false" ParseHTML="true">
                        </obout:Column>
                        <obout:Column DataField="OMSSKUCode" HeaderText="SKU Code" Align="left" HeaderAlign="left"
                            Width="13%" AllowFilter="false" ParseHTML="true">
                        </obout:Column>
