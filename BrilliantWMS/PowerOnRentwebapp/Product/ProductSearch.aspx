<%@ Page Title="Product Search" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master"
    AutoEventWireup="true" Theme="Blue" CodeBehind="ProductSearch.aspx.cs" Inherits="BrilliantWMS.Product.ProductSearch" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <td>
                <obout:Grid ID="GridProductSearch" runat="server" AutoGenerateColumns="false" AllowFiltering="false"
                    ...
                    <Columns>
                        ...
                        <%--<obout:Column DataField="PackKey" Visible="true" HeaderText="PackKey" Width="13%"
                            AllowFilter="false" ParseHTML="true">
                        </obout:Column>--%>
                                ...
                                <table>
                                    <tr>
                                        <td id="'<%# Container.DataItem["ID"].ToString() + "UpdTask" %>'" onmouseover="openFlyoutImage('<%# Container.DataItem["ID"].ToString()%>', this)">
                                            <a>
                                                <asp:Image ID="ImageDisplay" runat="server" ImageUrl='<%# "DisplaySkuImage.ashx?ID="+ (Container.DataItem["ID"].ToString()) %>' Height="50px" Width="50px" Style="border: solid 2px gray; cursor: pointer;" />
                                            </a>
                                        </td>
                                    </tr>
                                </table>
    ...
    <script type="text/javascript">
        ...
        function openFlyoutImage(img,invoker){
            ...
            imgg.src="DisplaySkuImage.ashx?ID="+ img +"";            
