<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    CodeBehind="ImportFSo.aspx.cs" Inherits="BrilliantWMS.POR.ImportFSo" Theme="Blue" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
    ...
    <div class="divHead" id="divRequestHead">
        <h4>
            <asp:Label ID="lblHeading" runat="server" Text="Import Images"/>
        </h4>
    </div>
    <div class="divHead" id="div1">
                    ...
                    <td class="tdCartStepHolder">
                        <span class="cartStepHolder"><span class="cartStepTitle"><span class="divCartSymbol">
                            <asp:Label ID="lbl1" runat="server" Text="1" /></span><asp:Label ID="lblstep1" runat="server"
                                Text="Upload File" /></span><span class="cartStepTitle"><span class="divCartSymbol"><asp:Label
                                    ID="lbl2" runat="server" Text="2" /></span><asp:Label ID="lblstep2" runat="server"
                                        Text="Data Validation & Verification" /></span><span class="cartStepTitle cartStepCurrentTitle"><span
                                            class="divCartSymbol divCartCurrentSymbol"><asp:Label ID="lbl3" runat="server" Text="3" /></span><asp:Label
                                                ID="lblstep3" runat="server" Text="Finished" /></span></span>
                    </td>
                </tr>
        </center>
        <tr>
        ...
        <tr>
            <td>
                <span>
                    <h1>
                        <asp:Label ID="lblSuccess" runat="server" Text="Images Importing Successfully Finished" />
                    </h1>
                </span>
            </td>
        </tr>
        ...
        <tr>
            <td class="style2" style="margin-left">
                &nbsp;<a href="ImportDSo.aspx"><input type="button" id="btnCancle" value="Finish"
                    runat="server" style="font-weight: bold;" /></a>
            </td>
        </tr>
        </table>
    </div>
