<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="ProductCategoryMaster.aspx.cs" Inherits="BrilliantWMS.Product.ProductCategoryMaster" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CPHolder_Form" runat="server">
                ...
                <table class="tableForm">
                                           <tr>
                                                ...
                                                <td style="text-align: left"> 
                                                   <asp:DropDownList ID="ddlcompanymain" ClientIDMode="Static" runat="server" Width="187px" DataTextField="Name" DataValueField="ID" onchange="GetCustomer()">
                                                  </asp:DropDownList>
                                                ...
                                                <td style="text-align: left">
                                                    <asp:DropDownList ID="ddlcustomer" runat="server" ValidationGroup="Save" Width="187px"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:TextBox ID="txtPrdCategory" runat="server" Width="187px" onKeyPress="return alpha(event);"
                        ...
                        <td>
                            <obout:Grid ID="gvPrdCat" runat="server" AllowAddingRecords="false" AllowFiltering="true"
                                ...
                                <Columns>
                                    ...
                                    <obout:Column DataField="Category" HeaderText="Product Category" Width="6%">
                                    </obout:Column>
                                      <obout:Column DataField="Company" HeaderText="Company Name" Width="6%">
                                    </obout:Column>
                                    <obout:Column DataField="Customer" HeaderText="Customer" Width="6%">
                                    </obout:Column>
                                    <obout:Column DataField="Active" HeaderText="Active" Width="3%">
                                    </obout:Column>
                                     <obout:Column DataField="CompanyID" HeaderText="CompanyID" Width="3%" Visible="false">
                                    </obout:Column>
                                     <obout:Column DataField="CustomerID" HeaderText="CustomerID" Width="3%" Visible="false">
                                    </obout:Column>
                                </Columns>
                                <Templates>
    ...
    <script type="text/javascript">
        ...
        var ddldeptid = document.getElementById("<%=ddlcustomer.ClientID %>");
