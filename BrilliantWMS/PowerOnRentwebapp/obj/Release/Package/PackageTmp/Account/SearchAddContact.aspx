<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="SearchAddContact.aspx.cs"  EnableEventValidation="false"
    Inherits="BrilliantWMS.Account.SearchAddContact" Theme="Blue" %>
        ...
        function GetContactPerson() {
            ...
            if (hdnSelectedRec.value == "") {
                ...
                if (count > 1) {
                    ...
                    var hdnSearchConEmail = window.opener.document.getElementById("hdnSearchConEmail");
                    var hdnSearchConMobNo = window.opener.document.getElementById("hdnSearchConMobNo");
                    ...
                    if (gvContactPerson.SelectedRecords.length > 0) {
                        for (var i = 0; i < gvContactPerson.SelectedRecords.length; i++) {
                            ...
                            if (hdnSearchContactID1.value == "") {
                                ...
                                hdnSearchConEmail.value = record.EmailID;
                                hdnSearchConMobNo.value = record.MobileNo;
                            }
                        }
                        window.opener.AfterContact1Selected(hdnSearchContactID1.value, hdnSearchContactName1.value, hdnSearchConEmail.value, hdnSearchConMobNo.value);
                        self.close();
                    }
                }
        }
