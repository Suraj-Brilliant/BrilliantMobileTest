<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="BINSearch.aspx.cs" 
    Theme="Blue" Inherits="BrilliantWMS.Product.BINSearch" %>
            ...
            <td>
                <obout:Grid ID="GridProductSearch" runat="server" AutoGenerateColumns="false" AllowFiltering="false"
                    ...
                    <Columns>
                        ...
                        <obout:Column DataField="LocAliasCode" HeaderText="Loc. Alias Code" Width="15%" Align="left" HeaderAlign="left"
