<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM2.Master" AutoEventWireup="true" CodeBehind="LocationBySKU.aspx.cs"
    Inherits="BrilliantWMS.Warehouse.LocationBySKU" Theme="Blue" %>
            ...
            <td>
                <obout:Grid ID="GridProductSearch" runat="server" AutoGenerateColumns="false" AllowFiltering="true"
                    ...
                    <Columns>
                        ...
                        <obout:Column DataField="Code"  HeaderText="location Code" Width="10%" >
                        </obout:Column>
                         <obout:Column DataField="AliasCode"  HeaderText="Alias Code" Width="10%" >
                        </obout:Column>
                         <obout:Column DataField="Value" Visible="true" HeaderText="Location Type" Width="8%">
                        </obout:Column>
                        <obout:Column DataField="Capacity" Visible="true" HeaderText="Capacity" Width="8%">
                        </obout:Column>
                        <obout:Column DataField="FilledCapacity" HeaderText="Filled Capacity" Align="left" HeaderAlign="left" Width="10%" >
                        </obout:Column>
        ...
        function selectedRec() {
            ...
            if (GridProductSearch.SelectedRecords.length > 0) {
                for (var i = 0; i < GridProductSearch.SelectedRecords.length; i++) {
                    ...
                    if (hdnlocationSearchName.value != "") hdnlocationSearchName.value += ',' + record.Code;
                    if (hdnLocationSearchID.value != "") hdnLocationSearchID.value += ',' + record.ID;
                    if (hdnlocationSearchName.value == "") {
                        hdnlocationSearchName.value = record.Code;
