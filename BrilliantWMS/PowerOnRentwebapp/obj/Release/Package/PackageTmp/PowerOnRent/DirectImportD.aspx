<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/CRM.Master" AutoEventWireup="true" CodeBehind="DirectImportD.aspx.cs" EnableEventValidation="false" 
    Inherits="BrilliantWMS.PowerOnRent.DirectImportD" Theme="Blue" %>
                        ...
                        <tr>
                            <td align="left" colspan="4">
                                   ...
                                   <%-- <span style="font-size:14px;"> Import will faciliated Order Data to be directly imported into OMS.</span><br />--%>
                                    ...
                                    <a href="DirectOrderImport.xlsx" target="_blank"><font color="blue"><u>Click Here.
                                   </u></font></a>
                    ...
                    <table align="right">
                        <tr>
                            <td>
                                ...
                                <asp:Button ID="Button12" runat="server" Text="  Next  " OnClick="Button12_Click" CausesValidation="false"   />     <%-- OnClientClick="return CheckDeptvalidations();"--%>
                            </td>
                            <td>
